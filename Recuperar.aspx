...
<body>
    <div class="container">
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <label for="TextBox2">Correo:</label>
                <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="Ingrese su correo"></asp:TextBox>
            </div>
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Restablecer" CssClass="btn btn-custom btn-block" />
